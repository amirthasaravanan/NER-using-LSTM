...
evelop an LSTM-based model to recognize named entities from text using the ner_dataset.csv, with words and NER tags as features.
...
ddef train_model(model, train_loader, test_loader, loss_fn, optimizer, epochs=3):
...
<img width="1678" height="687" alt="image" src="https://github.com/user-attachments/assets/58726796-7ea9-4105-9b3f-e7ddfe398189" />



### Sample Text Prediction
<img width="1674" height="715" alt="image" src="https://github.com/user-attachments/assets/545618d0-562e-4c27-a6f3-73b4541365eb" />
